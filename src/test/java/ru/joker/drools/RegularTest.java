 ...
 */
public class RegularTest extends AbstractDroolsTest {
    ...
    private final Customer callee = new Customer("007", Tariff.SIMPLE);
    ...
    public void testSingle() {
        ...
        BigDecimal expectedResult = PRICE;
    ...
    public void testMultiple() {
        ...
        BigDecimal expectedResult = PRICE.multiply(new BigDecimal("11"));
        BigDecimal actualResult = executeGetInvoice(callee,
